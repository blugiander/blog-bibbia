...
## 2. Il Roveto: La Presenza Non Mediabile

Il Roveto ardente è la rivelazione di un Dio che non può essere:
...
Entra come carne, non come profilo.

---

## 3. Le Piaghe: Il Collasso delle Infrastrutture

Le piaghe non sono punizioni magiche.
...
Ogni sistema totalizzante deve essere smascherato nella sua vulnerabilità.

---

## 4. Il Mare: Il Limite che Diventa Passaggio

Il Mar Rosso è il simbolo del **limite trasformato in via**.

- Per chi domina: è muro.  
...
La liberazione non è un percorso già tracciato.

È un cammino che appare solo mentre lo percorri.
...
- non possedere il domani  

La Manna è **grazia a consumo immediato**.
